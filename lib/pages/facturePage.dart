          ...
          data: ThemeData(
            ...
            textButtonTheme: TextButtonThemeData(
              style: TextButton.styleFrom(
                foregroundColor:
                    Colors.orange, // Couleur des boutons "OK" et "Annuler"
              ),
            ),
          ),
          child: child!,
    ...
    if (picked != null) {
      selectedRange.value = DateTimeRange(
        start: picked.start,
            ...
            hours: 23, minutes: 59, seconds: 59)), // 🔥 Correction ici
      );
                ...
                if (selectedRange.value != null) {
                  filteredInvoices = filteredInvoices.where((invoice) {
                    return invoice.createdAt
                            .isAfter(selectedRange.value!.start) &&
                            ...
                            return InkWell(
                              ...
                              child: Padding(
                                ...
                                child: InvoiceItem(
                                  ...
                                  productCount: invoice.sale.items.fold(
                                      0, (total, e) => total + e.quantity),
...
class InvoicePagee extends StatelessWidget {
  ...
  const InvoicePagee(
      {super.key, required this.invoice, required this.isDeliveryPage});
  ...
  Future<void> _generateAndPrintPDF() async {
    ...
    final ByteData data = await rootBundle.load('assets/shoptrak.jpg');
